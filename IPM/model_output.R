...
################################################################
# model 1.1 - assumes fixed legal harvest and no illegal harvest
load("no_ih.RData")
...
par(mfrow = c(1,3), cex.main = 1.5, mar = c(5, 6, 4, 5) + 0.1, mgp = c(3.5, 1, 0), cex.lab = 1.5, 
...
################################################################
# model 1.2 - assumes fixed legal harvest and uninformed illegal harvest

load("ih_uninformed.RData")
...
hest = 0.2 # true value 0.2
ihest = out2$sims.list$mu.ih # max value = 7
...
hist(ihest, breaks = 10, 
     main = "Illegal Harvest", xlim = c(0, 50))
...
Hpred = matrix(NA, n.years, n.sims)
Rpred = matrix(NA, n.years, n.sims)
IHpred = matrix(NA, n.years, n.sims)
...
HpredU = matrix(NA, n.years, n.sims)
RpredU = matrix(NA, n.years, n.sims)
IHpredU = matrix(NA, n.years, n.sims)
...
HpredL = matrix(NA, n.years, n.sims)
RpredL = matrix(NA, n.years, n.sims)
IHpredL = matrix(NA, n.years, n.sims)
...
for(t in 3:n.years){
  ...
  IHpred[t,] = rpois(n.sims, quantile(ihest, probs = 0.5))
  IHpredU[t,] = rpois(n.sims, quantile(ihest, probs = 0.75))
  IHpredL[t,] = rpois(n.sims, quantile(ihest, probs = 0.25))
...
###########################################################################
# model 1.3 - WITH survey data that informs rates of unreported fishing

load("ih_informed.RData")
...
hest = 0.2 # true value 0.2
ihest = out3$sims.list$mu.ih # max value = 7
...
for(t in 3:n.years){
  ...
  IHpred[which(IHpred > 7)] <- 7
  IHpredU[which(IHpredU > 7)] <- 7
  IHpredL[which(IHpredL > 7)] <- 7
